-- Backfill 14: lote 02 de identidad documental de providers.
-- Regla aprobada:
...
-- - "Maprika De Ecuador" -> "Maprika" / "del Ecuador"
-- - "Ing. Humberto Reyes" -> "Humberto" / "Reyes"
...
partes as (
  select
    ...
    full_name,
    case
      when full_name = 'Maprika De Ecuador' then 'Maprika'
      when full_name = 'Ing. Humberto Reyes' then 'Humberto'
    ...
    case
      when full_name = 'Maprika De Ecuador' then 'del Ecuador'
      when full_name = 'Ing. Humberto Reyes' then 'Reyes'
