...
SERVICIOS_MAXIMOS_ONBOARDING = int(os.getenv("PROVIDER_ONBOARDING_MAX_SERVICES", "7"))
SERVICIOS_MINIMOS_PERFIL_PROFESIONAL = int(
    os.getenv("PROVIDER_PROFILE_COMPLETION_MIN_SERVICES", "3")
)
CERTIFICADOS_MAXIMOS = int(os.getenv("PROVIDER_MAX_CERTIFICATES", "3"))
