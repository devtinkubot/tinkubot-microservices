    ...
    def _convertir_resultado_busqueda_a_formato_legacy(
        ...
        for proveedor in proveedores:
            proveedor_legacy = {
                ...
                "category_name": proveedor.get("category_name"),
                "classification_confidence": proveedor.get("classification_confidence"),
                "retrieval_score": proveedor.get("retrieval_score"),
