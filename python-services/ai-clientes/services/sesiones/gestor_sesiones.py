...
class GestorSesiones:
    ...
    async def delete_sessions(self, phone: str) -> bool:
        ...
        try:
            ...
            session_key = f"session:{phone}"
            if self.cliente_redis and self.cliente_redis.redis_client:
                await self.cliente_redis.delete(session_key)
    ...
    async def get_session_stats(self) -> Dict[str, Any]:
        ...
        """
        try:
            session_keys = await self.cliente_redis.redis_client.keys("session:*")
